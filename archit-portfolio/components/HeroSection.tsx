        ...
        */}
        ...
        <div className="absolute bottom-8 left-8 md:bottom-16 md:left-16 z-40 max-w-xs">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-oswald text-crimson text-sm tracking-widest uppercase">Archit Story</span>
          </div>
          <p className="font-inter text-xs md:text-sm text-white/70 leading-relaxed">
            <strong className="text-white">PART A.</strong> AI Undergraduate from SVNIT with interests in Technical Product, AI Product, workflow automation, and scalable digital systems.
          </p>
        </div>
